...
- Saved searches: store the current condition under a name from the toolbar bookmark menu and recall it later in editable form (same-name saves update in place)
